...
export const TemplateCard = ({ thumbnailImg, isSeleted, onSelect }) => {
  return (
    ...
    ${
      isSeleted ? ' border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50'
      ...
      {thumbnailImg ? (
        <div className=" relative w-full h-full overflow-hidden">
          ...
          <div className=" absolute inset-0 bg-gradient-to-t from-violet-100/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          </div>
        </div>
      ) : (
        <div className=" w-full h-[200px] items-center flex flex-col justify-center bg-gradient-to-r from-violet-50 via-violet-600 to-fuchsia-50">
